...
"Inside" each project you see a list of all "named" configuration (MTrelease, etc.) in combination with a Platform (x64, Win32). 
...
Here:	nana.C11	- project name (modificable),
	...
	_MTrelease	- build configuration. Here Multi-threaded (/MT), static linked with the std 			  cpp library and without debug information, optimized for release. 
	_x64		- the platform.
